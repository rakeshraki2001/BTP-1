...
if __name__ == "__main__":
    ...
    BG.add_weighted_edges_from((u, v, (u+1)*(v+1)) for u, v in BG.edges())
    W = list()
    ...
    plot_graph(BG, selected_edges, BG.edges - selected_edges,
               "green")  # selected edges based on the b-matching algorithm